          	  ...
          	  ?>
          			<tr id="travel_content_<?php echo $value1->id;?>">
          			    <td style="text-align:center;padding:2px 2px;">
          			       <span class="around_no"><span class="newest_trave_box1_img"><?php echo $trave->get_trave_first_image($value1->id);?></span></span>
          			    </td>
          			    <td width="80">
          			      <span class="around_price"><?php $trave_price=$trave->get_trave_price($value1->id); if($this->trave_category=='4') echo "一团一议"; else echo Util::enlarge_first($trave_price)."元起";?></span>
          			    </td>
          			    <td>
