...
function get_sregion_id($ip){
	if(empty($ip))
	  return;
	$sregion_name=$this->convertip($ip);
	$district=new District();
	$conditions="INSTR(:sregion_name,district_name)>0 AND district_category=:district_category";
	$params=array(':sregion_name'=>$sregion_name,':district_category'=>'3');
	$district_datas=$district->find($conditions,$params);
