<?php
class AgencyController extends AController
{
	...
	public function FilterEditFilter($filterChain) {
  	  ...
  	  $validate_datas= Agency::model()->find(array('condition'=>'t.id=:id','params'=>array(':id'=>$id),'with'=>array('User')));
	...
	{
		return array(
		  'index'=>'application.backend.controllers.agency.IndexAction',
		  'add'=>'application.backend.controllers.agency.AddAction',
		  'search'=>'application.backend.controllers.agency.SearchAction',
		  'delete'=>'application.backend.controllers.agency.DeleteAction',
