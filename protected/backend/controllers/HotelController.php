<?php
class HotelController extends AController
{
	...
	public function FilterEditFilter($filterChain) {
  	  ...
  	  $validate_datas= Hotel::model()->find(array('condition'=>'t.id=:id','params'=>array(':id'=>$id),'with'=>array('User')));
	...
	{
		return array(
		  'index'=>'application.backend.controllers.hotel.IndexAction',
		  'add'=>'application.backend.controllers.hotel.AddAction',
		  'search'=>'application.backend.controllers.hotel.SearchAction',
		  'delete'=>'application.backend.controllers.hotel.DeleteAction',
