<?php
class HotviewController extends AController
{
	...
	public function FilterEditFilter($filterChain) {
  	  ...
  	  $validate_datas= HotView::model()->find(array('condition'=>'t.id=:id','params'=>array(':id'=>$id),'with'=>array('User')));
	...
	{
		$path = 'application.backend.controllers.hotview.';
		return array(
