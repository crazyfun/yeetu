...
class AddAction extends BaseAction{
  ...
  protected function do_action(){	
		...
		$trave_sregion_name="";
		if(!empty($id)){
			 $this->controller->bc(array("国内游"=>array('domestic/index'),"修改国内游线路"));
      ...
      $district_sdatas= $district_model->findAll("id='$trave_sregion'",array());
		...
		$this->display('add_domestic',array('model'=>$model,'category_region_name'=>$category_region_name,'trave_region_name'=>$trave_region_name,'trave_sregion_name'=>$trave_sregion_name,'category_datas_json'=>json_encode($category_datas_json)));
  }
