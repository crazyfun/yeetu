...
class AddAction extends BaseAction{
  ...
  protected function do_action(){	
		...
		$trave_sregion_name="";
		if(!empty($id)){
			 $this->controller->bc(array("跟团游"=>array('group/index'),"修改跟团游线路"));
      ...
      $district_sdatas= $district_model->findAll("id='$trave_sregion'",array());
			...
			$this->controller->bc(array("跟团游"=>array('group/index'),"增加跟团游线路"));
		}
		$this->display('add_group',array('model'=>$model,'category_region_name'=>$category_region_name,'trave_region_name'=>$trave_region_name,'trave_sregion_name'=>$trave_sregion_name,'category_datas_json'=>json_encode($category_datas_json)));
  }
