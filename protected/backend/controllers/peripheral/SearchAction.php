...
class SearchAction extends BaseAction{
  ...
  protected function do_action(){	
	  ...
	  if($validate_sregion){
		...
		array_push($condition,"trave_category=:trave_category AND recycle=0");
  	...
  	$sort->params=$page_params;
       ...
       'sort'=>$sort,
		...
		$this->display('peripheral',array('model'=>$model,'active_data_provider'=>$active_data_provider,'com_condition_search'=>$com_condition_search,'trave_name'=>$trave_name,'show_index'=>$show_index,'trave_hot'=>$trave_hot));
  }
