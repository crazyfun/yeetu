<?php
class AddperipheralAction extends BaseAction{
  ...
  protected function do_action(){	
      ...
      if($model->validate()){
	    ...
	    $this->display('add_peripheral',array('model' => $model,'category_region_name'=>$category_region_name,'trave_region_name'=>$trave_region_name,'category_datas_json'=>json_encode($category_datas_json)));
  }
