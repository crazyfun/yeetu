<?php
class OrderhhAction extends BaseAction{
  
    protected function beforeAction(){
    	$this->controller->check_login("",CV::RETURN_ADMIN_INDEX,array());
    	$this->controller->init_page();
    	$this->controller->bc(array("订单酒店管理"));
      return true;
    }
  ...
  protected function do_action(){	
      ...
      'sort'=>$sort,
		...
		$this->display('order_hh',array('model'=>$model,'active_data_provider'=>$active_data_provider,'com_condition_search'=>$com_condition_search,'order_id'=>$order_id,'create_id'=>$create_id,'create_time'=>$create_time,'operate_time'=>$operate_time,'trave_name'=>$trave_name,'order_status'=>$order_status,'pay_status'=>$pay_status));
