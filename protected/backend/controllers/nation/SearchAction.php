...
class SearchAction extends BaseAction{
  ...
  protected function do_action(){	
      ...
      'sort'=>$sort,
		...
		$this->display('nation',array('model'=>$model,'active_data_provider'=>$active_data_provider,'com_condition_search'=>$com_condition_search,'trave_name'=>$trave_name,'show_index'=>$show_index,'trave_hot'=>$trave_hot));
  }
