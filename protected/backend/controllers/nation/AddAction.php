...
class AddAction extends BaseAction{
  ...
  protected function do_action(){	
		...
		$trave_sregion_name="";
		if(!empty($id)){
			 $this->controller->bc(array("境外游"=>array('nation/index'),"修改境外游线路"));
      ...
      $district_sdatas= $district_model->findAll("id='$trave_sregion'",array());
			...
			$this->controller->bc(array("境外游"=>array('nation/index'),"添加境外游线路"));
		}
		$this->display('add_nation',array('model'=>$model,'category_region_name'=>$category_region_name,'trave_region_name'=>$trave_region_name,'trave_sregion_name'=>$trave_sregion_name,'category_datas_json'=>json_encode($category_datas_json)));
  }
