...
class SearchAction extends BaseAction{
  ...
  protected function do_action(){	
	  ...
	  if(!empty($create_time)){
		...
		$this->display('index',array('model'=>$model,'com_condition_search'=>$com_condition_search,'create_name'=>$create_name,'user_login'=>$user_login,'level'=>$level,'user_active'=>$user_active,'status'=>$status,'create_time'=>$create_time));
  } 
}
?>
