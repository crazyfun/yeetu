...
class AddAction extends BaseAction{
  ...
  protected function do_action(){	
		...
		$trave_sregion_name="";
		if(!empty($id)){
			 $this->controller->bc(array("国际机+酒店"=>array('freetn/index'),"修改国际机+酒店线路"));
      ...
      $district_sdatas= $district_model->findAll("id='$trave_sregion'",array());
			...
			$this->controller->bc(array("国际机+酒店"=>array('freetn/index'),"增加国际机+酒店线路"));
		}
		$this->display('add_freetn',array('model'=>$model,'category_region_name'=>$category_region_name,'trave_region_name'=>$trave_region_name,'trave_sregion_name'=>$trave_sregion_name,'trave_hotels_name'=>$trave_hotels_name,'category_datas_json'=>json_encode($category_datas_json),'hotels_datas_json'=>json_encode($hotels_datas_json)));
  }
