  ...
  <div class="order_main">
	...
	<div class="clear_float"></div>
	  ...
	  <div class="order_box"><h2>线路信息</h2>
	    <table  cellspacing="0" class="order_table">
            ...
            <tr>
              ...
              <td align="center" class="order_date"><span><?php echo $start_time;?></span></td>
              <td align="center"> <?php echo empty($adult_nums)?0:$adult_nums;?>成人,<?php echo empty($child_nums)?0:$child_nums ?>儿童 </td>
            </tr>
        </table>
     ...
     <div class="order_box"><h2>保险信息</h2>
	  ...
	  <div class="order_price">总价：<span class="order_show"><?php echo $total_price;?></span>元</div>
