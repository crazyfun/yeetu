 <?php
   if($this->beginCache("travelbargaindetail", array('duration'=>"1"))){  

 ?> 
   
   <div class="around_right">
    <div class="DIYimg"><?php echo Util::get_ad('23') ;?></div>
     <?php  
                $this->widget('BargainDetail',array(
                    	 'trave_category'=>'2',//周边游
                    	 'trave_sregion'=>$this->trave_sregion,
               	)); 
     ?>
	 <?php  
				$this->widget('BargainDetail',array(
						'trave_category'=>'3',//国内游
						'trave_sregion'=>$this->trave_sregion,
					)); 
	 ?>
	 <?php  
                $this->widget('BargainDetail',array(
                    	 'trave_category'=>'1',//出境游
                    	 'trave_sregion'=>$this->trave_sregion,
               	)); 
     ?>
      <?php  
                $this->widget('BargainDetail',array(
                    	 'trave_category'=>'4',//团队游
                    	 'trave_sregion'=>$this->trave_sregion,
               	)); 
     ?>  
	 <?php  
