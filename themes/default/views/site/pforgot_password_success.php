  ...
  <div class="login_l">
    <div class="reg">
      ...
      <table border="0" width="550">
        <tbody>
          <tr>
            <td>我们已经给您的<span class="user_data_tip"><?php echo $user_phone;?></span>发送一条短信，请查看并使用新密码进行登录。</td>
          </tr>

          <tr>
            <td><img src="/css/images/login_io.gif "/>&nbsp;&nbsp;如果有任何疑问，请<a href="<?php echo $this->createUrl("statics/index",array('cid'=>'12')); ?>">联系我们</a>的客服，谢谢！</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
