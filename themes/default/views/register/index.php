  <div class="login_l">
    ...
    <div class="reg">
      ...
      <table border="0" width="550">
        <tbody>
          <tr>
            <td colspan="2" class="reg_title" style="padding-bottom:10px">欢迎注册易途会员！</td>
          </tr>
          <!--
          <tr>
            <td><strong>手机号码：</strong></td>
            <td><?php echo  $form->textField($model,"user_phone",array('class'=>'gm_login_input'));?><b>*</b><span class="input_error" id="user_phone_tip"><?php echo $form->error($model,'user_phone'); ?></span><span><a href="javascript:get_phone_verification('User_user_phone');">获取验证码</a></span><br /></td>
          </tr>
          -->
          ...
          <tr>
            <td width="85"><strong>用户名/昵称：</strong></td>
            <td width="508"><?php echo $form->textField($model,"user_login",array('class'=>'gm_login_input validate_input'));?><b>*</b><span class="input_error" id="user_login_tip" show_content="用户名/昵称，长度2至16位的任意字符" ><?php echo $form->error($model,'user_login'); ?></span></td>
          </tr>
          <tr>
            <td><strong>输入密码：</strong></td>
            <td><?php echo $form->passwordField($model,"password",array('class'=>'gm_login_input validate_input'));?><b>*</b><span class="input_error" id="password_tip" show_content="请输入有效的密码"><?php echo $form->error($model,'password'); ?></span><br /></td>
          </tr>
          <tr>
            <td><strong>确认密码：</strong></td>
            <td><?php echo $form->passwordField($model,"con_password",array('class'=>'gm_login_input validate_input'));?><b>*</b><span class="input_error" id="con_password_tip" show_content="请填写确认密码"><?php echo $form->error($model,'con_password'); ?></span><br /></td>
          </tr>
          
          <!--
          <tr>
            <td><strong>验&nbsp;证&nbsp;码：</strong></td>
            <td><?php echo $form->textField($model,"user_phone_verification",array('class'=>'gm_login_input'));?><b>*</b><span class="input_error"><?php echo $form->error($model,'user_phone_verification'); ?></span>  
            </td>
          </tr>
        -->
          ...
          <tr>
            ...
            <td><?php echo $form->textField($model,"email",array('class'=>'gm_login_input validate_input'));?><b>*</b><span class="input_error" id="email_tip" show_content="请填写有效邮箱地址，以获得注册验证信息"><?php echo $form->error($model,'email'); ?></span></td>
          </tr>
          
          
          <tr>
            <td colspan="2"><span>为便于您参加易途旅游网各类活动、提高服务质量，请完整填写以下选填内容： [以下信息为非必填项]</span></td>
          </tr>
          <tr>
            <td><strong>手机号码：</strong></td>
            <td><?php echo  $form->textField($model,"user_phone",array('class'=>'gm_login_input'));?><span id="user_phone_tip" class="input_error"  show_content="请填写正确的手机号码"><?php echo $form->error($model,'user_phone'); ?></span><span></span></td>
          </tr>
          <tr>
            <td><strong>真实姓名：</strong></td>
            <td><?php echo $form->textField($model,"real_name",array('class'=>'gm_login_input'));?><br /></td>
          </tr>
          <tr>
            <td><strong>性　　别：</strong></td>
            <td>
            	<?php  if($model->user_sex=='1')  $checked=true; else $checked=false; echo CHtml::radioButton("user_sex",$checked,array('value'=>'1'));?>&nbsp;男&nbsp;&nbsp;<?php if($model->user_sex=='2')  $checked=true; else $checked=false; echo CHtml::radioButton("user_sex",$checked,array('value'=>'2'));?>&nbsp;女</td>
          </tr>
          <tr>
            <td><strong>联系地址：</strong></td>
            <td><?php echo $form->textField($model,"user_address",array('class'=>'gm_login_input'));?> <br /></td>
          </tr>
          <tr>
            <td><strong>邮　　编：</strong></td>
            <td><?php echo $form->textField($model,"user_zip",array('class'=>'gm_login_input'));?>  <br /></td>
          </tr>
          <!--
          <tr>
            <td>&nbsp;</td>
            <td><?php echo $form->checkBox($model,"agreement_free",array()); ?>&nbsp;&nbsp;愿意接受旅游资讯免费信息<span class="input_error"><?php echo $form->error($model,'agreement_free'); ?></span></td>
          </tr>
          
          -->
          <tr>
            <td>&nbsp;</td>
            <td><?php echo $form->checkBox($model,"agreement",array('CHECKED'=>'CHECKED')); ?>&nbsp;&nbsp;我已阅读并接受<a href="javascript:show_agreement_dialog();">易途会员协议</a><span class="input_error"><?php echo $form->error($model,'agreement'); ?></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><?php echo CHtml::imageButton("/css/images/login_bt1.gif");?></td>
          </tr>
        </tbody>
      </table>
      <?php $this->endWidget(); ?>
...
<p><strong>八、免责声明</strong><br />
  会员明确同意其使用易途旅游网服务所存在的风险将完全由其自己承担；因其使用易途旅游网服务而产生的一切后果也由其自己承担，本网站对用户不承担任何责任。</p>
