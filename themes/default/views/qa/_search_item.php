...
<?php echo empty($_GET['s']) ? (CHtml::link($data->question->subject,array('qa/view','id'=>$data->question->id))) : (CHtml::link(Util::replace_search_keyword($data->question->subject,$_GET['s']),array('qa/view','id'=>$data->question->id)));?>
<?php echo $data->question->get_status_image();?>
</span>
...
<span class="ask_w_box_content">
<?php echo empty($_GET['s']) ? (CHtml::encode($data->content)) : (Util::replace_search_keyword(CHtml::encode($data->content),$_GET['s']));?></span>
