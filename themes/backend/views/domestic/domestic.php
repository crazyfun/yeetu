...
<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("domestic/add",array());?>">增加国内游线路</a></span></div></div>
       ...
       <div class="search_content">
       	...
       	<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'searchtrave-form',
          'action'=>$this->createUrl("domestic/search",array()),
       ...
       <div class="show_search_content">
       	   ...
       	   <div class="show_search_text">
                 <div class="operate_all"><a  href="javascript:submit_trave_form('deletetrave-form','/backend.php/domestic/delete');">删除所有</a>&nbsp;&nbsp;<a  href="javascript:submit_trave_form('deletetrave-form','/backend.php/domestic/publish/status/2');">批量发布</a>&nbsp;&nbsp;<a  href="javascript:submit_trave_form('deletetrave-form','/backend.php/domestic/publish/status/1');">批量不发布</a></div>
       	   	    	<?php $form=$this->beginWidget('CActiveForm', array(
	        					'id'=>'deletetrave-form',
          					'action'=> '',
	        					'enableAjaxValidation'=>false,
