...
<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("domestic/index");?>">返回到国内游</a></span><span><a href="<?php echo $this->createUrl("domestic/addtraveroute",array("trave_id"=>$model->trave_id));?>">增加国内游行程</a></span></div></div>
