...
<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--û-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("domestic/index");?>">返回到国内游</a></span><span><a href='<?php echo $this->createUrl("domestic/traveroute",array('trave_id'=>$model->trave_id));?>'>返回到国内游行程</a></span></div></div>

    	<div class="edit_content">
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttraveroute-form',
          'action'=>$this->createUrl("domestic/inserttraveroute",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
    		<?php echo $form->hiddenField($model,"id");?>
    		<?php echo $form->hiddenField($model,"trave_id");?>
    		  <div class="operate_result"><?php $this->widget("FlashInfo");?></div>
			   <div class="jwy_add"><?php if($model->id) echo "国内游行程修改"; else echo "国内游行程添加"; ?></div>
           ...
           <div class="input_line"><div class="input_name">详情</div><div class="input_long_content">
           	...
           	<?php $this->widget('application.extensions.fckeditor.FCKEditorWidget',array(
    				"model"=>$model,                # Data-Model
   					"attribute"=>'route_describe',         # Attribute in the Data-Model
   					"height"=>'400px',
    				"width"=>'100%',
        ...
        ?>
           ...
           <div class="input_line"><div class="input_name">餐饮</div><div class="input_long_content"><?php echo $form->textField($model,"route_dining");?></div><div class="input_error"><?php echo $form->error($model,"route_dining");?></div><div class="clear_both"></div></div>
    		   <div class="input_line hasbgbot"><div class="edit_input_button"><div class="input_submit"><?php echo CHtml::submitButton("submit",array("value"=>'提交'));?></div><div class="input_cancel"><?php echo CHtml::resetButton("reset",array("value"=>'重置'));?></div><div class="add_more"><?php echo CHtml::link("新增",array("domestic/addtraveroute",'trave_id'=>$model->trave_id));?></div><div class="clear_both"></div></div></div>
    	<?php $this->endWidget(); ?>
    	</div>
    </div>
