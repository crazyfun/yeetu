...
<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--û-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("group/index");?>">返回到跟团游</a></span><span><a href='<?php echo $this->createUrl("group/travedate",array('trave_id'=>$model->trave_id));?>'>返回到跟团游时间</a></span></div></div>
    	
    	<div class="edit_content">
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttravedate-form',
          'action'=>$this->createUrl("group/inserttravedate",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
    		<?php echo $form->hiddenField($model,"id");?>
        <?php echo $form->hiddenField($model,"trave_id");?>
        <div class="operate_result"><?php $this->widget("FlashInfo");?></div>
        	<div class="jwy_add"><?php if($model->id) echo "跟团游时间修改"; else echo "跟团游时间添加"; ?></div>   
