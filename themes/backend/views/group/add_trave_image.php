<div id="page_content">
    <div class="show_right_content">
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("group/travearea",array("trave_id"=>$model->trave_id));?>">返回到团队游景区</a></span><span><a href='<?php echo $this->createUrl("group/traveimage",array('trave_id'=>$model->trave_id,"trave_area_id"=>$model->trave_area_id));?>'>返回到团队游景区图片</a></span></div></div>
    	<div class="edit_content">
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttraveimage-form',
          'action'=>$this->createUrl("group/inserttraveimage",array()),
           ...
           <div class="jwy_add"><?php if($model->id) echo "团队游景区图片修改"; else echo "团队游景区图片添加"; ?></div>
