...
<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("group/index");?>">返回到跟团游</a></span><span><a href="<?php echo $this->createUrl("group/addtravedate",array("trave_id"=>$model->trave_id));?>">增加跟团游时间</a></span></div></div>
       ...
       <div class="search_content">
          ...
          'action'=>$this->createUrl("group/searchtravedate",array()),
