<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--û-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("nation/index");?>">返回到境外游</a></span><span><a href='<?php echo $this->createUrl("nation/traveroute",array('trave_id'=>$model->trave_id));?>'>返回到境外游行程</a></span></div></div>

    	<div class="edit_content">
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttraveroute-form',
          'action'=>$this->createUrl("nation/inserttraveroute",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
    		<?php echo $form->hiddenField($model,"id");?>
    		<?php echo $form->hiddenField($model,"trave_id");?>
    		   <div class="operate_result"><?php $this->widget("FlashInfo");?></div>
               <div class="jwy_add"><?php if($model->id) echo "境外游行程修改"; else echo "境外游行程添加"; ?></div>
