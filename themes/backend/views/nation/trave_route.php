<div id="page_content">
    <div class="show_right_content">
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("nation/index");?>">返回到境外游</a></span><span><a href="<?php echo $this->createUrl("nation/addtraveroute",array("trave_id"=>$model->trave_id));?>">增加境外游行程</a></span></div></div>
       <!--示-->
