<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--û-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href='<?php echo $this->createUrl("nation/index",array());?>'>返回到境外游</a></span></div></div>
    	
    	<div class="edit_content">
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttrave-form',
          'action'=>$this->createUrl("nation/addnation",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
        
    		<?php echo $form->hiddenField($model,"id");?>
    		<div class="operate_result"><?php $this->widget("FlashInfo");?></div>
        <div class="jwy_add"><?php if($model->id) echo "境外游线路修改"; else echo "境外游线路添加"; ?></div>
    		<div class="input_line"><div class="input_name">线路名称</div><div class="input_long_content"><?php echo $form->textField($model,"trave_name");?></div><div class="input_error"><?php echo $form->error($model,'trave_name'); ?></div>
			<div><a href="javascript:show_clonedialog('<?php echo $model->id; ?>')">克隆线路</a></div><div class="clear_both"></div></div>
      ...
      <div class="input_line"><div class="input_name">供应商线路编号</div><div class="input_long_content"><?php echo $form->textField($model,"trave_suppliers_number");?></div><div class="input_error"><?php echo $form->error($model,'trave_suppliers_number'); ?></div><div class="clear_both"></div></div>
    	...
    	<!--	<div class="input_line"><div class="input_name">供应商</div><div class="input_long_content"><?php echo $form->textField($model,"trave_suppliers");?></div><div class="input_error"><?php echo $form->error($model,'trave_suppliers'); ?></div><div class="clear_both"></div></div>-->
        ...
        <div class="input_line"><div class="input_name">线路标题</div><div class="input_long_content"><?php echo $form->textField($model,"trave_title");?></div><div class="input_error"><?php echo $form->error($model,'trave_title'); ?></div><div class="clear_both"></div></div>
    		...
    		<?php if(!empty($model->id)){ ?>
    		   <div class="add_button"><?php echo CHtml::link("增加线路行程",array("nation/traveroute",'trave_id'=>$model->id));?></div>
    	  <?php } ?>
