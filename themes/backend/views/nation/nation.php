...
<div id="page_content">
    <div class="show_right_content">
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("nation/add",array());?>">增加境外游线路</a></span></div></div>
    	<!--淼?-->
       <div class="search_content">
       	<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'searchtrave-form',
          'action'=>$this->createUrl("nation/search",array()),
	        'enableAjaxValidation'=>false,
       	  ...
       	  <div class="search_item"><span class="search_item_name">热卖:</span><span class="search_item_input"><?php echo UserHmtl::get_select_value("trave_hot",array('1'=>'不是热卖','2'=>'是热卖'),$trave_hot,"热卖类型",$class_name=""); ?></span></div>
       	  <div class="search_item"><span class="search_item_name">特价:</span><span class="search_item_input"><?php echo UserHmtl::get_select_value("trave_bargain",array('1'=>'不是特价','2'=>'特价'),$model->trave_bargain,"特价类型",$class_name=""); ?></span></div><div class="search_item"><span class="search_item_name">&nbsp;</span><span class="search_item_input"><?php echo CHtml::textField("trave_name",$trave_name,array("id"=>"trave_name"));?></span></div>
