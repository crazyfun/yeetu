...
<div id="page_content">
    <div class="show_right_content">
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("hotels/add",array());?>">增加酒店</a></span></div></div>
    	<!--淼?-->
       <div class="search_content">
       	<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'searchhotel-form',
          'action'=>$this->createUrl("hotels/search",array()),
       	 ...
       	 <div class="search_item"><span class="search_item_name">酒店所在城市</span><span class="search_item_input"><input  type="hidden" id="hotel_city_id" name="hotel_city_id" value="<?php echo $model->hotel_city;?>"><input readonly id="hotel_city" onclick="javascript:select_hotel_city([{'id':'<?php echo $model->hotel_city;?>','name':'<?php echo $hotel_city_name; ?>'}]);" type="text" name="hotel_city" value="<?php echo $hotel_city_name; ?>"/></span></div>
       	   ...
       	   <div class="show_search_text">
       	   	<!--
       	   	   <div class="operate_all"><a  href="javascript:submit_form('deletetrave-form');">删除所有</a></div>
       	   	    	<?php $form=$this->beginWidget('CActiveForm', array(
	        					'id'=>'deletetrave-form',
          					'action'=> $this->createUrl("hotels/delete",array()),
	        					'enableAjaxValidation'=>false,
       						 )); ?>
       			-->
  ...
  <script language="javascript">
     jQuery(function($) {
     	...
     	jQuery("#hotel_name").Watermark("酒店名称/酒店ID");
	   
	     jQuery('#search_submit').click(function() {
	       if( jQuery("#hotel_name").val() == "酒店名称/酒店ID" ) jQuery("#hotel_name").val('');
	     });
