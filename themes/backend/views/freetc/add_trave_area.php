<div id="page_content">
    <div class="show_right_content">
    	<!--û-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("freetc/index");?>">返回到国内机+酒店</a></span><span><a href='<?php echo $this->createUrl("freetc/travearea",array('trave_id'=>$model->trave_id));?>'>返回到国内机+酒店景区</a></span></div></div>
    	
    	<div class="edit_content">
    		
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttravearea-form',
          'action'=>$this->createUrl("freetc/inserttravearea",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
           <?php echo $form->hiddenField($model,"id");?>
           <?php echo $form->hiddenField($model,"trave_id");?>
           <div class="operate_result"><?php $this->widget("FlashInfo");?></div>
          <div class="jwy_add"><?php if($model->id) echo "国内机+酒店景区修改"; else echo "国内机+酒店景区添加"; ?></div>
