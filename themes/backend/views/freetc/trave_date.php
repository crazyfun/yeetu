<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("freetc/index");?>">返回到国内机+酒店</a></span><span><a href="<?php echo $this->createUrl("freetc/addtravedate",array("trave_id"=>$model->trave_id));?>">增加国内机+酒店时间</a></span></div></div>
       ...
       <div class="search_content">
          ...
          'action'=>$this->createUrl("freetc/searchtravedate",array()),
