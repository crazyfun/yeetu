...
<div id="page_content">
    <div class="show_right_content">
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("motorcade/index");?>">返回到车队管理</a></span><span><a href="<?php echo $this->createUrl("motorcade/add",array());?>">增加车队</a></span></div></div>
    	<!--淼?-->
       <div class="search_content">
       	<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'searchsystem-form',
          'action'=>$this->createUrl("motorcade/search",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
       	  <?php echo CHtml::hiddenField("id",$model->id);?>
       	  <div class="search_item"><span class="search_item_name">车队名称:</span><span class="search_item_input"><?php echo CHtml::textField("motorcade_name",$motorcade_name,array('id'=>'search_motorcade_name'));?></span></div>
                  ...
                  'columns'=>array(
                     ...
                     array(
                      ...
                      array(
                       'name'=>"motorcade_link",
                       'type'=>'raw',
                       'value'=>'$data->motorcade_link'
                      ),
					  array(
                       'name'=>"motorcade_phone",
                       'type'=>'raw',
                       'value'=>'$data->motorcade_phone'
                      ),
					   array(
                       'name'=>"拥有车辆",
                       'type'=>'raw',
                       'value'=>'$data->get_motorcade_cars()'
                      ),
                     array(
                       'name'=>"motorcade_fax",
                       'type'=>'raw',
                     ...
                     array(
                       'name'=>"操作",
                       'type'=>'raw',
                       'value'=>'$data->get_motorcade_operate()'
					//	'value'=>'$data->id'
                      ), 
