<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--û-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href='<?php echo $this->createUrl("nianhui/index",array());?>'>返回到年会酒店</a></span></div></div>
    	
    	<div class="edit_content">
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttrave-form',
          'action'=>$this->createUrl("nianhui/addfreetc",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
        
    		<?php echo $form->hiddenField($model,"id");?>
    		<div class="operate_result"><?php $this->widget("FlashInfo");?></div>
          	<div class="jwy_add"><?php if($model->id) echo "年会酒店修改"; else echo "年会酒店添加"; ?></div>
