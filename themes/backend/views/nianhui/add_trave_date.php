...
<div id="page_content">
    <div class="show_right_content">
    	...
    	<!--û-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("nianhui/index");?>">返回到年会酒店</a></span><span><a href='<?php echo $this->createUrl("nianhui/travedate",array('trave_id'=>$model->trave_id));?>'>返回到年会酒店时间</a></span></div></div>
    	
    	<div class="edit_content">
    		<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'inserttravedate-form',
          'action'=>$this->createUrl("nianhui/inserttravedate",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
    		<?php echo $form->hiddenField($model,"id");?>
        <?php echo $form->hiddenField($model,"trave_id");?>
       <div class="operate_result"><?php $this->widget("FlashInfo");?></div>
        	<div class="jwy_add"><?php if($model->id) echo "年会酒店时间修改"; else echo "年会酒店时间添加"; ?></div>   
