    ...
    <div class="show_right_content">
       ...
       <div class="search_content">
       	<?php $form=$this->beginWidget('CActiveForm', array(
	        'id'=>'searchtrave-form',
          'action'=>$this->createUrl("recycletrave/search",array()),
	        'enableAjaxValidation'=>false,
        )); ?>
       
       	  <div class="search_item"><span class="search_item_name">显示类型:</span><span class="search_item_input"><?php echo UserHmtl::get_select_value("trave_status",array('1'=>'未发布','2'=>'已发布'),$model->trave_status,"请选择类型",$class_name=""); ?></span></div><div class="search_item"><span class="search_item_name">推荐:</span><span class="search_item_input"><?php echo UserHmtl::get_select_value("trave_recommend",array('1'=>'未推荐','2'=>'推荐'),$model->trave_recommend,"推荐类型",$class_name=""); ?></span></div><div class="search_item"><span class="search_item_name">特价:</span><span class="search_item_input"><?php echo UserHmtl::get_select_value("trave_bargain",array('1'=>'不是特价','2'=>'特价'),$model->trave_bargain,"特价类型",$class_name=""); ?></span></div><div class="search_item"><span class="search_item_name">&nbsp;</span><span class="search_item_input"><?php echo CHtml::textField("trave_name",$model->trave_name,array("id"=>"trave_name"));?></span></div>
       	  <div class="search_item"><span class="search_item_name">预定类型:</span><span class="search_item_input"><?php echo UserHmtl::get_select_value("trave_ordain",array('1'=>'立即预定'),$model->trave_ordain,"预定类型",$class_name=""); ?></span></div>
       	   ...
       	   <div class="show_search_text">
                  ...
                  'columns'=>array(
                     ...
                     array(
                       'name'=>"操作",
                       'type'=>'raw',
                       'value'=>'$data->get_recycle_trave_operate()'
