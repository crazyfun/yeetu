<div id="page_content">
    <div class="show_right_content">
    	<!--没-->
    	<div class="user_operate"><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("freetn/travearea",array("trave_id"=>$model->trave_id));?>">返回到国际机+酒店景区</a></span><span><a href="<?php echo $this->createUrl("freetn/addtraveimage",array("trave_id"=>$model->trave_id,"trave_area_id"=>$model->trave_area_id));?>">增加国际机+酒店景区图片</a></span></div></div>
       <!--示-->
       <div class="show_search_content">
       	   <!--示牡-->
       	   <div class="show_search_text">
       	   	   <div class="operate_all"><a href="javascript:submit_form('deletetraveimage-form');">删除所有</a>&nbsp;&nbsp;<a href="<?php echo $this->createUrl("freetn/addtraveimage",array("trave_id"=>$model->trave_id,"trave_area_id"=>$model->trave_area_id));?>">修改景区图片</a></div>
